    ...
    <>
      ...
      <section className="homePrimary">
        <div className="primaryTable">
          ...
          {activeTab === "Golf" || activeTab === "Skincare" || activeTab === "Makeup" || activeTab === "Haircare" || activeTab === "Fragrance" || activeTab === "Nails" || activeTab === "Bodycare" || activeTab === "Dresses" || activeTab === "Activewear" || activeTab === "Shoes" || activeTab === "Jewelry" || activeTab === "Handbags" || activeTab === "Menswear" || activeTab === "Energy" || activeTab === "Snacks" || activeTab === "Coffee" ? (
